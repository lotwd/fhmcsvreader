export const teamStatsRows = (teams, leagueId) => {
    const rows = teams.map(team=>(
        {
            ...
            goalsAllowedPerGame:team?.stats?.goalsAllowedPerGame,
            goalsForVsGoalsAgainst:team?.stats?.goalsForVsGoalsAgainst,
            shots:team?.stats?.shots,
            shotsPerGame:team?.stats?.shotsPerGame,
            shotsAllowed:team?.stats?.shotsAllowed,
            shotsAllowedPerGame:team?.stats?.shotsAllowedPerGame,
            ...
            hitsPerGame:team?.stats?.hitsPerGame,
            takeaways:team?.stats?.takeaways,
            takeawaysPerGame:team?.stats?.takeawaysPerGame,
            giveaways:team?.stats?.giveaways,
            giveawaysPerGame:team?.stats?.giveawaysPerGame,
            injuries:team?.stats?.injuries,
            penaltiesPerGame:team?.stats?.penaltiesPerGame,
            powerplays:team?.stats?.powerplays,
            powerplaysPerGame:team?.stats?.powerplaysPerGame,
            ...
            shortHandedGoalsPerGame:team?.stats?.shortHandedGoalsPerGame,
            shorthandedGoalsAllowed:team?.stats?.shorthandedGoalsAllowed,
            scoredFirstTotal:team?.stats?.scoredFirstTotal,
